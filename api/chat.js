export default async function handler(req, res) {
  try {
    ...
    const systemPrompt = `You are a ${persona}. Respond to the user's message in a way that is helpful and engaging. Provide personalized advice, support, or entertainment. Be empathetic and understanding.`;
